...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2023 a las 16:14:38
...
CREATE TABLE `documental` (
  ...
  `fecha_estreno` date NOT NULL DEFAULT '2023-11-30'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `documental` (`id`, `titulo`, `anio`, `duracion`, `id_administrador`, `url`, `id_proveedor_audiovisual`, `id_mpaa`, `descripcion`, `img`, `fecha_estreno`) VALUES
(1, 'Malala', 2021, '01:30:00', 1, 'http://url1.com', 1, 1, 'Documental para aprender jugando', 'https://images.pexels.com/photos/839428/pexels-photo-839428.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2021-07-23'),
(2, 'El ultimo baile', 2019, '02:15:00', 1, 'http://url2.com', 1, 2, 'Imperdible para amantes de la danza', 'https://images.pexels.com/photos/3949681/pexels-photo-3949681.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2018-03-22'),
(3, '1945', 2022, '01:45:00', 1, 'http://url3.com', 1, 3, 'Una mirada a la historia', 'https://images.pexels.com/photos/16849391/pexels-photo-16849391/free-photo-of-monumento-militar-historia-guerra.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2024-01-19'),
(4, 'Juventus', 2023, '01:00:00', 1, 'http://url3.com', 1, 3, 'Una mirada a la historia', 'https://images.pexels.com/photos/114296/pexels-photo-114296.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2019-10-03'),
(5, 'Maravillas Naturales', 2022, '01:30:00', 1, 'url-del-video', 1, 1, 'Maravillas de la naturaleza - Argentina', 'https://images.pexels.com/photos/3158519/pexels-photo-3158519.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2022-05-12'),
(6, 'Vida Salvaje - El zorro gris', 1990, '01:30:00', 1, 'url-documental', 2, 3, 'Un acercamiento a la vida en la naturaleza del zorro gris.', 'https://images.pexels.com/photos/134058/pexels-photo-134058.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2023-11-30'),
(7, 'Space X ', 20223, '02:00:00', 1, 'url-space-x', 3, 5, 'Space Exploration Technologies Corp. conocida como SpaceX, es una empresa estadounidense de fabricación aeroespacial y de servicios de transporte espacial con sede en Hawthorne. Veamos un recorrido desde adentro.', 'https://images.pexels.com/photos/796206/pexels-photo-796206.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2024-08-05'),
(8, 'Remanentes Estelares - Enanas Blancas', 2020, '01:30:00', 1, 'url-enanas-blancas', 1, 4, 'Una enana blanca es un remanente estelar que se genera cuando una estrella de masa menor que 10 masas solares ha agotado su combustible nuclear. ¿Pero cuanto tiempo toma? Descubrelo', 'https://images.pexels.com/photos/39561/solar-flare-sun-eruption-energy-39561.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2023-12-16'),
(9, 'Superautos', 2019, '01:12:00', 1, 'url-autos', 2, 3, 'Los autos mas increibles que nunca imaginarias.', 'https://images.pexels.com/photos/919073/pexels-photo-919073.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2019-04-24'),
(10, 'Especies Invasoras ', 2021, '50:00:00', 1, 'url-catas', 3, 1, 'Especies imvasoras introducidas por humanos y su impacto en el ecosistema.', 'https://images.pexels.com/photos/1098254/pexels-photo-1098254.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '2024-02-13');
...
(1, 'martin', 'John', 'Doe', 'john.doe@example.com', 1, 1, '$2a$10$nvPlm4W2RF3BqZcjtllKuOHC9PNYma.mRKSZ8zHIOd4rmmOqOf76K', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJpYXQiOjE3MDE0MzEwODd9.SpPlHUn-vnTKQAmeoxfxwdR9hvXuBai-NpC318uEnfY'),
